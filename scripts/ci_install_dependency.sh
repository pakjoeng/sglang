...
if [ "$MODE_BLACKWELL" = "1" ]; then
    ...
    pip3 install https://github.com/sgl-project/whl/releases/download/v${SGL_KERNEL_VERSION}/sgl_kernel-${SGL_KERNEL_VERSION}+cu128-cp39-abi3-manylinux2014_x86_64.whl --break-system-packages
fi
